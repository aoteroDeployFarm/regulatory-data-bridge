...
TARGET_URL = "https://www.baaqmd.gov/rules-and-compliance"
CACHE_DIR = os.path.join(os.path.dirname(__file__), ".cache")
CACHE_FILE = os.path.join(CACHE_DIR, "rules_last_hash.txt")
...
def check_for_update():
    ...
    return {
        ...
        "diffSummary": "BAAQMD Rules & Compliance page content changed" if updated else "No change detected"
    }
