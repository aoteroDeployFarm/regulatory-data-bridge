...
TARGET_URL = "https://www.valleyair.org"
...
def extract_content(html):
    ...
    content = soup.find("div", id="content") or soup.find("table")
...
def check_for_update():
    ...
    return {
        ...
        "diffSummary": "Valley Air homepage content changed" if updated else "No change detected"
    }
