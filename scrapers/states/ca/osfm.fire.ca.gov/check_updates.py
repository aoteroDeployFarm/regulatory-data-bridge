...
TARGET_URL = "https://osfm.fire.ca.gov/divisions/pipeline-safety-division/"
...
def check_for_update():
    ...
    return {
        ...
        "diffSummary": "Pipeline Safety Division page content changed" if updated else "No change detected"
    }
