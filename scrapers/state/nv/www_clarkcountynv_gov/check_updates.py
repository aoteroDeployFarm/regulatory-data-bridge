...
TARGET_URL = "https://www.clarkcountynv.gov/government/departments/environment_and_sustainability/division_of_air_quality/permitting/"
...
def check_for_update() -> dict:
    return check_updated(
        ...
        selector='h1, h2, h3, a',
        url=TARGET_URL,
        diff_label='NV www.clarkcountynv.gov',
    )
